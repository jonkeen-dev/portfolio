...
export const projects: Project[] = [
  ...
  },
  {
    ...
    problem:
      "Miniature painters in the Warhammer 40k community often struggle to create cohesive color schemes. While general tools like Coolors or Adobe Color exist, none effectively combine an interactive color wheel with hobby-specific guidance for layering, shading, highlighting, and real paint equivalents from Citadel or Army Painter ranges. Hobbyists end up relying on scattered tutorials, forums, or manual trial-and-error, leading to inconsistent results, wasted paint, and schemes that clash under real lighting. PaletteForge addresses this gap by providing a dedicated web app where users start with a base color or faction theme and receive intelligent, harmonious palette suggestions grounded in color theory.",
    constraints:
